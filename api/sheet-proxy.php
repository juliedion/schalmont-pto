...
/* Which sheets this proxy is allowed to read (id => friendly name). */
$ALLOWED = [
...
if (!isset($ALLOWED[$id])) out(400, ['ok' => false, 'error' => 'That spreadsheet is not on the allowed list.']);
...
out(200, ['ok' => true, 'name' => $ALLOWED[$id], 'csv' => $csv]);
